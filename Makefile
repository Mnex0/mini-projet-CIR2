...
distdir: FORCE
	...
	$(COPY_FILE) --parents MainWindow.h model/City.h model/CityPoint.h model/DB.h model/Outline.h model/OutlinePoint.h model/Route.h model/RoutePoint.h $(DISTDIR)/
	$(COPY_FILE) --parents City.cpp main.cpp MainWindow.cpp Route.cpp model/Loader.cpp $(DISTDIR)/
...
Loader.o: model/Loader.cpp model/DB.h \
		model/Map.h \
		model/Outline.h \
		model/OutlinePoint.h \
		model/Route.h \
