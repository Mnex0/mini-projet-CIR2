#############################################################################
# Makefile for building: mini_projet
# Generated by qmake (3.1) (Qt 6.4.2)
# Project:  mini_projet.pro
# Template: app
# Command: /usr/bin/qmake -o Makefile mini_projet.pro
#############################################################################
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = mini_projet1.0.0
DISTDIR = /home/isen/ISEN/Algorithmie/Qt/mini_projet/.tmp/mini_projet1.0.0
LINK          = g++
LFLAGS        = -Wl,-O1 -Wl,-rpath-link,/usr/lib/x86_64-linux-gnu
LIBS          = $(SUBLIBS) -L/usr/lib -lmysqlcppconn /usr/lib/x86_64-linux-gnu/libQt6Widgets.so /usr/lib/x86_64-linux-gnu/libQt6Gui.so /usr/lib/x86_64-linux-gnu/libGLX.so /usr/lib/x86_64-linux-gnu/libOpenGL.so /usr/lib/x86_64-linux-gnu/libQt6Core.so -lpthread -lGLX -lOpenGL   
AR            = ar cqs
RANLIB        = 
SED           = sed
STRIP         = strip
...
SOURCES       = FenetrePrincipale.cpp \
		main.cpp \
		model/Loader.cpp moc_FenetrePrincipale.cpp \
		moc_ZoomCarte.cpp \
		moc_Minicarte.cpp
...
DIST          = /usr/lib/x86_64-linux-gnu/qt6/mkspecs/features/spec_pre.prf \
		...
		mini_projet.pro FenetrePrincipale.h \
		model/BDD.h \
		model/Carte.h \
		model/Contour.h \
		...
		model/Ville.h \
		ZoomCarte.h \
		Minicarte.h FenetrePrincipale.cpp \
		main.cpp \
		model/Loader.cpp
QMAKE_TARGET  = mini_projet
DESTDIR       = 
TARGET        = mini_projet
...
Makefile: mini_projet.pro /usr/lib/x86_64-linux-gnu/qt6/mkspecs/linux-g++/qmake.conf /usr/lib/x86_64-linux-gnu/qt6/mkspecs/features/spec_pre.prf \
		/usr/lib/x86_64-linux-gnu/qt6/mkspecs/common/unix.conf \
		/usr/lib/x86_64-linux-gnu/qt6/mkspecs/common/linux.conf \
		/usr/lib/x86_64-linux-gnu/qt6/mkspecs/common/sanitize.conf \
		/usr/lib/x86_64-linux-gnu/qt6/mkspecs/common/gcc-base.conf \
	...
	$(QMAKE) -o Makefile mini_projet.pro
...
distdir: FORCE
	...
	$(COPY_FILE) --parents FenetrePrincipale.h model/BDD.h model/Carte.h model/Contour.h model/PointContour.h model/PointVille.h model/Route.h model/Ville.h ZoomCarte.h Minicarte.h $(DISTDIR)/
	$(COPY_FILE) --parents FenetrePrincipale.cpp main.cpp model/Loader.cpp $(DISTDIR)/
...
compiler_moc_header_make_all: moc_FenetrePrincipale.cpp moc_ZoomCarte.cpp moc_Minicarte.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_FenetrePrincipale.cpp moc_ZoomCarte.cpp moc_Minicarte.cpp
moc_FenetrePrincipale.cpp: FenetrePrincipale.h \
	...
	/usr/lib/qt6/libexec/moc $(DEFINES) --include /home/isen/ISEN/Algorithmie/Qt/mini_projet/moc_predefs.h -I/usr/lib/x86_64-linux-gnu/qt6/mkspecs/linux-g++ -I/home/isen/ISEN/Algorithmie/Qt/mini_projet -I/home/isen/ISEN/Algorithmie/Qt/mini_projet -I/usr/include/x86_64-linux-gnu/qt6 -I/usr/include/x86_64-linux-gnu/qt6/QtWidgets -I/usr/include/x86_64-linux-gnu/qt6/QtGui -I/usr/include/x86_64-linux-gnu/qt6/QtCore -I/usr/include/c++/13 -I/usr/include/x86_64-linux-gnu/c++/13 -I/usr/include/c++/13/backward -I/usr/lib/gcc/x86_64-linux-gnu/13/include -I/usr/local/include -I/usr/include/x86_64-linux-gnu -I/usr/include FenetrePrincipale.h -o moc_FenetrePrincipale.cpp

moc_ZoomCarte.cpp: ZoomCarte.h \
		moc_predefs.h \
		/usr/lib/qt6/libexec/moc
	/usr/lib/qt6/libexec/moc $(DEFINES) --include /home/isen/ISEN/Algorithmie/Qt/mini_projet/moc_predefs.h -I/usr/lib/x86_64-linux-gnu/qt6/mkspecs/linux-g++ -I/home/isen/ISEN/Algorithmie/Qt/mini_projet -I/home/isen/ISEN/Algorithmie/Qt/mini_projet -I/usr/include/x86_64-linux-gnu/qt6 -I/usr/include/x86_64-linux-gnu/qt6/QtWidgets -I/usr/include/x86_64-linux-gnu/qt6/QtGui -I/usr/include/x86_64-linux-gnu/qt6/QtCore -I/usr/include/c++/13 -I/usr/include/x86_64-linux-gnu/c++/13 -I/usr/include/c++/13/backward -I/usr/lib/gcc/x86_64-linux-gnu/13/include -I/usr/local/include -I/usr/include/x86_64-linux-gnu -I/usr/include ZoomCarte.h -o moc_ZoomCarte.cpp

moc_Minicarte.cpp: Minicarte.h \
		moc_predefs.h \
		/usr/lib/qt6/libexec/moc
	/usr/lib/qt6/libexec/moc $(DEFINES) --include /home/isen/ISEN/Algorithmie/Qt/mini_projet/moc_predefs.h -I/usr/lib/x86_64-linux-gnu/qt6/mkspecs/linux-g++ -I/home/isen/ISEN/Algorithmie/Qt/mini_projet -I/home/isen/ISEN/Algorithmie/Qt/mini_projet -I/usr/include/x86_64-linux-gnu/qt6 -I/usr/include/x86_64-linux-gnu/qt6/QtWidgets -I/usr/include/x86_64-linux-gnu/qt6/QtGui -I/usr/include/x86_64-linux-gnu/qt6/QtCore -I/usr/include/c++/13 -I/usr/include/x86_64-linux-gnu/c++/13 -I/usr/include/c++/13/backward -I/usr/lib/gcc/x86_64-linux-gnu/13/include -I/usr/local/include -I/usr/include/x86_64-linux-gnu -I/usr/include Minicarte.h -o moc_Minicarte.cpp
...
Loader.o: model/Loader.cpp model/BDD.h \
		model/Carte.h \
		model/Contour.h \
		model/PointContour.h \
		model/Route.h \
		model/Ville.h \
		model/waypoint.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o Loader.o model/Loader.cpp
...
moc_ZoomCarte.o: moc_ZoomCarte.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_ZoomCarte.o moc_ZoomCarte.cpp

moc_Minicarte.o: moc_Minicarte.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_Minicarte.o moc_Minicarte.cpp
